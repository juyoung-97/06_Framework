...
public class EmailConfig {
	...
	public JavaMailSender javaMailSender() {
		// Spring 에서 JavaMailSender 를 구성하는 Bean 을 정의
		...
		mailSender.setPort(587); //SMTP 서버의 포트 587 설정
		mailSender.setDefaultEncoding("UTF-8"); // 기본 인코딩 설정
		mailSender.setJavaMailProperties(prop);
		// JavaMail의 속성을 설정(앞서 정의해둔 prop에 있는 설정들은 적용)
		
		return mailSender;
		// 위 처럼 각종 설정이 적용된 JavaMailSender 를
		// Bean으로 등록하여
