...
public class EditBoardController {
	...
	public String boardInsert(@PathVariable("boardCode") int boardCode) {
		...
		// src/main/resource/templates/board/boardWrite.html 로 forward
	}
	...
	public String boardInsert(@PathVariable("boardCode") int boardCode,
		...
		/*
		 * ** List<MultipartFile> images 는 실제 제출된 파일이 있던 없던 무조건
		 * 길이 5의 MultipartFile이 요소로 있는 List가 제출됨 **
		 * 
		 * - 5개 모두 업로드 0 -> 0 ~ 4 인덱스에 실제 파일 들어간 MultipartFile이 저장됨
