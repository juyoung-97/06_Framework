...
-- 번호 / 제목[댓글개수] / 작성자 닉네임 / 작성일 / 조회수 / 좋아요갯수
...
-- 전체 드래그 ALT+X
CREATE OR REPLACE FUNCTION NEXTT_IMG_NO
-- 반환형
RETURN NUMBER
-- 사용할 변수
IS IMG_NO NUMBER;
