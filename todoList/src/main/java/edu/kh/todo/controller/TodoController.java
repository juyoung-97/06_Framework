...
public class TodoController {
	...
	@Autowired // 의존성 주입(같은 타입 + 상속관계인 Bean을 의존성주입)
	...
	public String addTodo(@RequestParam("todoTitle") String todoTitle,
		...
		// 3. @ModelAttribute 와 DTO 를 이용하여 얻어오기
	 ...
	 * 			- 즉, todo 객체의 todoNo 와 complete 필드가 세팅 완료된 상태
	 * @return
	 */
	...
	public String todoDelete(@RequestParam("todoNo") int todoNo,
		...
		int todo = service.todoDelete(todoNo);
		String message = null;		
		String path = null;
